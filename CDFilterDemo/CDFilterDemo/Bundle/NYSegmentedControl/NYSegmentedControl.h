...
// Calios: added for action.(1110)
@protocol NYSegmentedControlDelegate <NSObject>

- (void)segmentedControl:(NYSegmentedControl *)control didSelectedAtIndex:(NSInteger)index;
...
@property (weak, nonatomic) IBOutlet id <NYSegmentedControlDelegate> delegate;// Calios: added for action.(1110)
...
@property (nonatomic) CGSize segmentedControlSize;
